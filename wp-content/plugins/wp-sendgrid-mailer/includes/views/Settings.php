...
<div class = 'container-fluid add-top-margin'>
	...
	<form name = 'wp-email-services' method = 'POST' action = ''>
		...
		<input type = "text" class = "form-control" name = "from_name" id = "from_name" placeholder = "From Name" style = 'width: 300px;' value = '<?php echo $from_info['from_name']; ?>' >
	    </div>
	    <div class = 'form-group'>
		<label for = "from_email"> From Email </label>
		<input type = "text" class = "form-control" name = "from_email" id = "from_email" placeholder = "From Email" style = 'width: 300px;' value = '<?php echo $from_info['from_email']; ?>' >
	    </div>
	    <div class = 'form-group'>
		...
		<div class = 'form-group'>
			...
			<input type = "text" class = "form-control" name = 'smtp_host' id = "smtp_host" placeholder = "smtp.gmail.com" style = 'width: 250px;' value = '<?php echo $data['smtp_host']; ?>' >
		    </div>
		    <div class="form-group">
			<label for = "smtp_port"> Port </label>
			<input type = "text" class = "form-control" name = 'smtp_port' id = "smtp_port" placeholder = "465" style = 'width: 50px;' value = '<?php echo $data['smtp_port']; ?>' >
		    </div>
		    <div class="form-group">
			...
			<input type = "text" class = "form-control" name = "smtp_username" id = "smtp_username" placeholder = "Username" style = 'width: 250px;' value = '<?php echo $data['smtp_username']; ?>' >
		    </div>
		    <div class="form-group">
			<label for = "smtp_password"> Password </label>
			<input type = "password" class = "form-control" name = "smtp_password" id = "smtp_password" placeholder = "Password" style = 'width: 250px;' value = '<?php echo $data['smtp_password']; ?>' >
		    </div>
		</div>
	    </div>
	    <!-- Sendgrid -->
		...
		<div class = 'form-group'>
		    ...
		    <input type = "text" class = "form-control" name = 'sendgrid_api_key' id = "sendgrid_api_key" placeholder = "API key" style = 'width: 650px;' value = '<?php echo $data['sendgrid_api_key']; ?>' >
